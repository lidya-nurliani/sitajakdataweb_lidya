  ...
  <div class = "card-body">
            <form action="{{ url('update-blmbayar', $blmbayar->id) }}" method="post">
              ...
              <div class="form-group">
                <select id="unit_kerja" name="unit_kerja" class="form-control" placeholder="Unit kerja" value="{{ $blmbayar->unit_kerja }}">
              ...
              <div class="form-group">
                ...
                <option value="{{ $item ['id'] }}"{{ $item ['id']==$blmbayar->dafken_id ? 'selected="selected"' : '' }}>{{ $item->no_polisi."(".$item->jenis_kendaraan.") - ".$item->nama_pemegang }}</option>
                @endforeach
              </select>
              </div>

              <div class="form-group">
                <input type="date" id="tgl_bayar_selanjutnya" name="tgl_bayar_selanjutnya" class="form-control" placeholder="tgl bayar" value="{{ $blmbayar->tgl_bayar }}">
              </div>
          ...
          <option  value=""> Pemegang</option>
            ...
            <option value="Pasif"> Pasif</option>
              ...
              <div class="form-group">
                <input type="text" id="keterangan" name="keterangan" class="form-control" placeholder="keterangan" value="{{ $blmbayar->keterangan }}">
              </div>
